...
const LightRays: React.FC<LightRaysProps> = ({
  ...
  // Forzar vec2/vec3 como tuplas fijas
  type Vec2 = [number, number];
  type Vec3 = [number, number, number];
  type UniformValue = number | Vec2 | Vec3;
  type Uniforms = Record<string, { value: UniformValue }>; // [web:19]
...
void main() {
  ...
  gl_FragColor  = color;
      ...
      // TIPADO E INICIALIZACIÓN COMO TUPLAS
      ...
      const updatePlacement = () => {
        ...
        uniforms.rayPos.value = anchor as Vec2;
        uniforms.rayDir.value = dir as Vec2;
      }; // [web:15][web:19]
