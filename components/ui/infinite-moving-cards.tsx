...
export const InfiniteMovingCards = ({
  ...
  // Actualiza cuando cambien direction/speed sin duplicar nodos
  useEffect(() => {
    getDirection();
  }, [getDirection]);
        ...
        {items.map((item) => (
          ...
          >
            <blockquote>
              ...
              />
              <span className="relative z-20 font-bold leading-[1.6] text-white">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-end bottom-0">
