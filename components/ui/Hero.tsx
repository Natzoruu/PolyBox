      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-black">
        <div className="text-center space-y-5 max-w-3xl z-10">
          <div className="space-y-3">
            <h1 className="text-7xl tracking-tight bg-clip-text bg-gradient-to-r from-pink-500 via-purple-400 to-blue-500 text-transparent h-20 font-bold  animate-gradient fade-in-1">
              Unlimited 3D Models
            </h1>
            <h1 className="text-6xl tracking-tight bg-clip-text bg-gradient-to-r from-blue-500 via-purple-400 to-pink-500 text-transparent h-20 font-semibold animate-gradient fade-in-2">
              for Your Creative Projects
            </h1>
            <p className="text-gray-400 text-lg text-pretty fade-in-3">
          ...
          <div className="space-x-20 mt-10 fade-in-4">
