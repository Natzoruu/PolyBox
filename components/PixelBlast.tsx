...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  type PrevCfg = { antialias: boolean; liquid: boolean; noiseAmount: number };
  const prevConfigRef = useRef<PrevCfg | null>(null);
  ...
  useEffect(() => {
    ...
    const needsReinitKeys: (keyof PrevCfg)[] = ['antialias', 'liquid', 'noiseAmount'];
    const cfg: PrevCfg = { antialias, liquid, noiseAmount };
    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        // Actualiza uTime en los efectos que lo requieren, sin usar any
